...
//2º Passo -> criar o cached, para armazear a conexão ao longo do projeto
//3º Passo -> criar a função de conexão com o mongoDB caso nao exista
//4º Passo -> verificar se já existe uma conexão previamente estabelecida
//5º Passo -> verificar se existe uma promessa de conexão pendente
//6º Passo -> estabelecer a conexão com o mongoDB
//7º Passo -> exportar a função de conexão com o mongoDB
